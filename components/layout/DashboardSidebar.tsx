...
const tocLinks = [
  { href: '/toc/dashboard', label: 'Dashboard', icon: '📊' },
...
const links = [
  { href: '/toc/dashboard', label: 'Dashboard', icon: '🏠' },
  { href: '/toc/settings', label: 'Settings', icon: '⚙️' },
];
...
export default function DashboardSidebar({ active }: { active?: string }) {
  ...
  return (
    <aside className="h-full w-64 bg-white border-r border-gray-100 shadow-lg flex flex-col py-8 px-4">
      <div className="mb-10 text-2xl font-extrabold text-emerald-600 tracking-tight text-center">Sequora</div>
