-- Migration: Add HF MEDIUM and LOW risk protocol rules
-- Duplicate HF HIGH rules for MEDIUM and LOW risk levels with appropriate severity filtering

-- ============================================================================
-- PROTOCOL CONFIGURATIONS
-- ============================================================================

-- Check if HF MEDIUM and LOW configs already exist, if not create them
...
SELECT 
  'PROTOCOL CONFIGS CREATED' as summary,
  condition_code,
  risk_level,
  critical_confidence_threshold,
  low_confidence_threshold
