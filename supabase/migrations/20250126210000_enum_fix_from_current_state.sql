...
BEGIN
  ...
  ELSE
    RAISE NOTICE 'ProtocolContentPack.severity already enum, skipping';
  END IF;
END $$;
...
BEGIN
  ...
  ELSE
    RAISE NOTICE 'ProtocolContentPack.rule_type already enum, skipping';
  END IF;
END $$;
...
BEGIN
  ...
  ELSE
    RAISE NOTICE 'Episode.risk_level already enum, skipping';
  END IF;
END $$;
...
BEGIN
  ...
  ELSE
    RAISE NOTICE 'ProtocolAssignment.risk_level already enum, skipping';
  END IF;
END $$;
...
BEGIN
  ...
  ELSE
    RAISE NOTICE 'ProtocolConfig.risk_level already enum, skipping';
  END IF;
END $$;
...
BEGIN
  ...
  ELSE
    RAISE NOTICE 'ProtocolConfig.condition_code already enum, skipping';
  END IF;
END $$;
...
BEGIN
  ...
  ELSE
    RAISE NOTICE 'Patient.education_level already enum, skipping';
  END IF;
END $$;
